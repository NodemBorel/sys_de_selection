                                ...
                                <tbody>
                                    @foreach ($candidats_tous as $candidat)
                                        <tr>
                                            ...
                                            <td><a href="{{ url('/view_acte_naiss_l1', $candidat->id) }}"
                                                    class="btn btn-warning btn-sm" style="display: inline;">view</a>
                                                <!-- <a href="{{ url('/download_acte_naiss', $candidat->acte_naissance) }}" class="btn btn-primary btn-sm" style="display: inline;">download</a> -->
                                            </td>
                                            <td><a href="{{ url('/view_releve_l1', $candidat->id) }}"
                                                    class="btn btn-warning btn-sm" style="display: inline;">view</a>
                                                <!-- <a href="{{ url('/download', $candidat->releve_bac) }}" class="btn btn-primary btn-sm" style="display: inline;">download</a> -->
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
