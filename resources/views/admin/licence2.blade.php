...
<div class="container-fluid px-4">
    <div class="row" id="alert-container">
        ...
        <div class="col-md">
            <div class="card card-body">
                <h5>Importer:</h5>
                <hr>
                <form action="{{ url('/licence2_import') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
    ...
    <div class="d-flex justify-content-center">
        <form class="my-form" action="{{ url('/delete_list2') }}" method="POST">
            @csrf
            <div class="my-3 mx-2">
    ...
    <div class="row">
        <div class="col-md">
            <div class="card card-body">
                ...
                <form class="form-inline" action="{{ url('/selectlicence2') }}" method="get">
                    <div class="form-group">
                        <label for="mgp1">MGP Niveau 1 >= à</label>
                        <input type="number" class="form-control" id="mgp1" placeholder="MGP 1" name="mgp1" style="width: 150px;">
                    </div>
    ...
    <div class="d-flex justify-content-center">
        <form class="my-form" action="{{ url('/validselect2') }}" method="POST">
            @csrf
            <div class="my-3 mx-2">
        ...
        <div class="col">
            <div class="card card-body d-flex justify-content-center">
                <div class="row">
                    ...
                    <div class="col-md">
                        <a class="btn btn-success" href="{{ url('/licence2_exportpdf') }}">Export pdf</a>
                    </div>

                    <div class="col-md">
                        <a class="btn btn-warning" href="{{ url('/licence2_export-excel') }}">Export Excel</a>
                    </div>
...
<script src="{{ asset('styles/js/stop_selection/stop_l2.js') }}"></script>
<script>
