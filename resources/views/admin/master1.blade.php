...
@section('content')
    ...
    <div class="container-fluid px-4">
        <div class="row" id="alert-container">
            ...
            <div class="col-md">
                <div class="card card-body">
                    <h5>Importer:</h5>
                    <hr>
                    <form action="{{ url('/master1_import') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
            ...
            <div class="col-md">
                <div class="card mt-4">
                    <div class="card-header">
                        <h4 class="border-bottom pb-2 mb-4" style="color: #0088cc;">LISTE DES CANDIDATS DU <b>MASTER 1</b>
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="myDataTable" class="table table-sm table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Age</th>
                                        <th>MGP L3</th>
                                        <th>Nom de l'Etablissement L3</th>
                                        <th>Filiere</th>
                                ...
                                <tbody>
                                    @foreach ($candidats as $candidat)
                                        <tr>
                                            ...
                                            <td>{{ $candidat->age }}</td>
                                            <td>{{ $candidat->mgp3 }}</td>
                                            <td>{{ $candidat->nomEtb3 }}</td>
                                            <td>{{ $candidat->filiere }}</td>
                                            <td><a href="{{url('/view_acte_naiss_M1',$candidat->id)}}" class="btn btn-warning btn-sm" style="display: inline;">view</a></td>
                                            <td><a href="{{url('/view_releve_M1',$candidat->id)}}" class="btn btn-warning btn-sm" style="display: inline;">view</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
        ...
        <div class="row">
            <div class="col-md">
                <div class="card card-body">
                    ...
                    <form class="form-inline" action="{{ url('/selectmaster1') }}" method="get">

                        <div class="form-group">
                            <label for="moyenne">MGP L3 >= à</label>
                ...
                <div class="card mt-4">
                    <div class="card-header">
                        <h4 class="border-bottom pb-2 mb-4" style="color: #0088cc;">LISTE DES CANDIDATS SELECTIONNES À
                            PARTIR DE CES CRITERES DU <b>MASTER 1</b></h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    @foreach ($pre_candidats as $pre_candidat)
                                        <tr>
                                            ...
                                            <td>{{ $pre_candidat->mgp3 }}</td>
                                            <td>{{ $pre_candidat->nomEtb3 }}</td>
        ...
        <div class="d-flex justify-content-center">
            <form class="my-form" action="{{ url('/validselectM1') }}" method="POST">
                @csrf
                <div class="my-3 mx-2">
            ...
            <div class="col">
                <div class="card card-body d-flex justify-content-center">
                    <div class="row">
                        ...
                        <div class="col-md">
                            <a class="btn btn-success" href="{{ url('/master1_exportpdf') }}">Export pdf</a>
                        </div>

                        <div class="col-md">
                            <a class="btn btn-warning" href="{{ url('/master1_export-excel') }}">Export Excel</a>
                        </div>

                        <div class="col-md">
                            <a href="email-selectM1" class="btn btn-primary">Notifier candidats</a>
                        </div>

                        <form class="col-md" action="{{ url('delete-selectM1') }}" method="POST">
                            @csrf
                            <div class="col-md">
    ...
    <script src="{{ asset('styles/js/stop_selection/stop_m1.js') }}"></script>
    <script>
