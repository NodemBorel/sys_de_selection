            ...
            <div class="col-md">
                <div class="card mt-4">
                    <div class="card-header">
                        <h4 class="border-bottom pb-2 mb-4" style="color:rgb(0, 130, 115);">LISTE DES CANDIDATS DU <b>MASTER
                                1</b>
                        </h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($candidats as $candidat)
                                        <tr>
                                            ...
                                            <td><a href="{{ url('/view_acte_naiss_M1', $candidat->id) }}"
                                                    class="btn btn-warning btn-sm" style="display: inline;">view</a></td>
                                            <td><a href="{{ url('/view_releve_M1', $candidat->id) }}"
                                                    class="btn btn-warning btn-sm" style="display: inline;">view</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
