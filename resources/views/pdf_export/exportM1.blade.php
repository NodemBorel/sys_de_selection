...
<head>
    ...
    <title>SYS-SELECT | Export Pdf MASTER 1</title>
...
<body>
        ...
        <h3 style="color: #0088cc; margin-bottom: 20px; text-align: center; font-style: italic;">BIENVENUE SUR LA PAGE MASTER 1</h3>
        </div>
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Etablissement L3</th>
                            <th scope="col">MGP L3</th>
