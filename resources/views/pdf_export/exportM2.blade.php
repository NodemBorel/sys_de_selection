...
<head>
    ...
    <title>SYS-SELECT | Export Pdf MASTER 2</title>
...
<body>
        ...
        <h3 style="color: #0088cc; margin-bottom: 20px; text-align: center; font-style: italic;">BIENVENUE SUR LA PAGE MASTER 2</h3>
        </div>

        <div class="my-3 p-3 bg-body rounded shadow-sn">
            <h4 class="border-bottom pb-2 mb-4" style="color: #0088cc; font-style: italic;">LISTE DES CANDIDATS SELECTIONNES  DU MASTER 2</h4>
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Etablissement M1</th>
                            <th scope="col">MGP M1</th>
