            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="multi-step-form" method="post" action="{{ url('/submit-licence2') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="step" id="step2" style="display: none;">
                                ...
                                <div class="form-group md-3 py-1">
                                    ...
                                    <input type="number" min="0" max="20" step="0.01" id="moyenne"
                                        name="moyenne" class="form-control" required>
                                </div>
                            ...
                            <div class="step" id="step3" style="display: none;">
                                <div class="form-group md-3 py-3">
                                    ...
                                    <input type="number" min="0" max="20" step="0.01"
                                        class="form-control" id="mgp1" name="mgp1" required required>
                                </div>
                            ...
                            <div class="step" id="step4" style="display: none;">
                                ...
                                <div class="form-group md-3 py-1">
                                    ...
                                    <select class="form-control" name="delivBac" id="delivBac" required>
