            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="multi-step-form" method="post" action="{{ url('/submit-doctorat') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="step" id="step2" style="display: none;">
                                ...
                                <div class="form-group md-3 py-3">
                                    <label for="">Nom Etablissement Niveau 5</label>
                                    <input type="text" class="form-control" id='nomEtb5' name="nomEtb5" required>
                                </div>
                            ...
                            <div class="step" id="step3" style="display: none;">
                                <div class="form-group md-3 py-3">
                                    <label for="age">MGP Niveau 5</label>
                                    <input type="number" min="0" max="20" step="0.01" class="form-control" id="mgp5" name="mgp5" required>
                                </div>
