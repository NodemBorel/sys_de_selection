            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="multi-step-form" method="post" action="{{ url('/submit-licence3') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="step" id="step2" style="display: none;">
                                ...
                                <div class="form-group md-3 py-1">
                                    <label for="">Nom Etablissement Niveau 1</label>
                                    <input type="text" class="form-control" id='nomEtb1' name="nomEtb1" required>
                                </div>
                            ...
                            <div class="step" id="step3" style="display: none;">
                                <div class="form-group md-3 py-3">
                                    <label for="">Nom Etablissement Niveau 2</label>
                                    <input type="text" class="form-control" id='nomEtb2' name="nomEtb2" required>
                                </div>

                                <div class="form-group md-3 py-1">
                                    <label for="age">MGP Niveau 2</label>
                                    <input type="number" min="0" max="20" step="0.01" class="form-control" id="mgp2" name="mgp2" required>
                                </div>
