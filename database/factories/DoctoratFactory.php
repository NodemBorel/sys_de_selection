...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Doctorat>
 */
class DoctoratFactory extends Factory
{
    /**
    ...
    protected $model = Doctorat::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'nomEtb5' => $this->faker->company,
            'mgp5' => $this->faker->randomFloat(2, 1, 4),
