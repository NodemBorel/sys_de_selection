...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Master1>
 */
class Master1Factory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'nomEtb3' => $this->faker->company,
            'mgp3' => $this->faker->randomFloat(2, 1, 4),
